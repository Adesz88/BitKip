...
public class DownloadModel {
    ...
    public static DownloadModel createDownload(ResultSet rs, boolean fetchQueue) throws SQLException {
        ...
        //TODO handle it normally
        var retrievedTurnOffMode = rs.getString(COL_TURNOFF_MODE).equals("null") ? TurnOffMode.NOTHING.toString() : rs.getString(COL_TURNOFF_MODE) ;
        var turnOffMode = TurnOffMode.valueOf(retrievedTurnOffMode);
